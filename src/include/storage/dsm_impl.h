...
extern PGDLLIMPORT bool dsm_impl_op(dsm_op op, dsm_handle handle, Size request_size,
						void **impl_private, void **mapped_address, Size *mapped_size,
						int elevel);

/* Implementation-dependent actions required to keep segment until shutdown. */
extern PGDLLIMPORT void dsm_impl_pin_segment(dsm_handle handle, void *impl_private,
								 void **impl_private_pm_handle);
extern PGDLLIMPORT void dsm_impl_unpin_segment(dsm_handle handle, void **impl_private);
