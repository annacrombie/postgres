...
extern PGDLLIMPORT void WalSndSetState(WalSndState state);

/*
 * Internal functions for parsing the replication grammar, in repl_gram.y and
 * repl_scanner.l
 */
extern PGDLLIMPORT int	replication_yyparse(void);
extern PGDLLIMPORT int	replication_yylex(void);
extern PGDLLIMPORT void replication_yyerror(const char *str) pg_attribute_noreturn();
extern PGDLLIMPORT void replication_scanner_init(const char *query_string);
extern PGDLLIMPORT void replication_scanner_finish(void);
extern PGDLLIMPORT bool replication_scanner_is_replication_command(void);
