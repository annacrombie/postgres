...
extern PGDLLIMPORT int	scram_SaltedPassword(const char *password, const char *salt,
								 int saltlen, int iterations, uint8 *result,
								 const char **errstr);
extern PGDLLIMPORT int	scram_H(const uint8 *str, int len, uint8 *result,
					const char **errstr);
extern PGDLLIMPORT int	scram_ClientKey(const uint8 *salted_password, uint8 *result,
							const char **errstr);
extern PGDLLIMPORT int	scram_ServerKey(const uint8 *salted_password, uint8 *result,
							const char **errstr);

extern PGDLLIMPORT char *scram_build_secret(const char *salt, int saltlen, int iterations,
