...
typedef struct PgStatShmHashEntry
{
	...
	/* pointer to shared stats in PgStat_StatEntryHeader */
	dsa_pointer body;
} PgStatShmHashEntry;
...
typedef struct PgStatKindInfo
{
	 ...
	 */
	void		(*reset_timestamp_cb) (PgStatShm_StatEntryHeader *header, TimestampTz ts);
...
extern void pgstat_shared_stat_drop_ref(PgStatSharedRef *shared_ref);
...
extern void pgstat_schedule_stat_drop(PgStatKind kind, Oid dboid, Oid objoid);
extern void pgstat_schedule_stat_create(PgStatKind kind, Oid dboid, Oid objoid);
...
extern void pgstat_database_reset_timestamp(Oid dboid, TimestampTz ts);
extern bool pgstat_database_flush_cb(PgStatSharedRef *shared_ref, bool nowait);
extern void pgstat_database_reset_timestamp_cb(PgStatShm_StatEntryHeader *header, TimestampTz ts);
...
extern bool pgstat_function_flush_cb(PgStatSharedRef *shared_ref, bool nowait);
...
extern bool pgstat_relation_flush_cb(PgStatSharedRef *shared_ref, bool nowait);
extern void pgstat_relation_pending_delete_cb(PgStatSharedRef *shared_ref);
...
extern void pgstat_replslot_restore(const PgStat_StatReplSlotEntry *tmp);

extern void pgstat_replslot_reset_all_cb(TimestampTz now);
extern void pgstat_replslot_snapshot_cb(void);
...
extern bool pgstat_wal_flush(bool nowait);
...
extern bool pgstat_subscription_flush_cb(PgStatSharedRef *shared_ref, bool nowait);
extern void pgstat_subscription_reset_timestamp_cb(PgStatShm_StatEntryHeader *header, TimestampTz ts);
