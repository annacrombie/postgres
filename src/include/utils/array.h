 ...
 */
extern PGDLLIMPORT void CopyArrayEls(ArrayType *array,
						 Datum *values,
						 bool *nulls,
						 int nitems,
						 int typlen,
...
extern PGDLLIMPORT Datum array_get_element(Datum arraydatum, int nSubscripts, int *indx,
							   int arraytyplen, int elmlen, bool elmbyval, char elmalign,
							   bool *isNull);
extern PGDLLIMPORT Datum array_set_element(Datum arraydatum, int nSubscripts, int *indx,
							   Datum dataValue, bool isNull,
							   int arraytyplen, int elmlen, bool elmbyval, char elmalign);
extern PGDLLIMPORT Datum array_get_slice(Datum arraydatum, int nSubscripts,
							 int *upperIndx, int *lowerIndx,
							 bool *upperProvided, bool *lowerProvided,
							 int arraytyplen, int elmlen, bool elmbyval, char elmalign);
extern PGDLLIMPORT Datum array_set_slice(Datum arraydatum, int nSubscripts,
							 int *upperIndx, int *lowerIndx,
							 bool *upperProvided, bool *lowerProvided,
							 Datum srcArrayDatum, bool isNull,
							 int arraytyplen, int elmlen, bool elmbyval, char elmalign);

extern PGDLLIMPORT Datum array_ref(ArrayType *array, int nSubscripts, int *indx,
					   int arraytyplen, int elmlen, bool elmbyval, char elmalign,
					   bool *isNull);
extern PGDLLIMPORT ArrayType *array_set(ArrayType *array, int nSubscripts, int *indx,
							Datum dataValue, bool isNull,
							int arraytyplen, int elmlen, bool elmbyval, char elmalign);

extern PGDLLIMPORT Datum array_map(Datum arrayd,
					   struct ExprState *exprstate, struct ExprContext *econtext,
					   Oid retType, ArrayMapState *amstate);

extern PGDLLIMPORT void array_bitmap_copy(bits8 *destbitmap, int destoffset,
							  const bits8 *srcbitmap, int srcoffset,
							  int nitems);

extern PGDLLIMPORT ArrayType *construct_array(Datum *elems, int nelems,
								  Oid elmtype,
								  int elmlen, bool elmbyval, char elmalign);
extern PGDLLIMPORT ArrayType *construct_md_array(Datum *elems,
									 bool *nulls,
									 int ndims,
									 int *dims,
									 int *lbs,
									 Oid elmtype, int elmlen, bool elmbyval, char elmalign);
extern PGDLLIMPORT ArrayType *construct_empty_array(Oid elmtype);
extern PGDLLIMPORT ExpandedArrayHeader *construct_empty_expanded_array(Oid element_type,
														   MemoryContext parentcontext,
														   ArrayMetaState *metacache);
extern PGDLLIMPORT void deconstruct_array(ArrayType *array,
							  Oid elmtype,
							  int elmlen, bool elmbyval, char elmalign,
							  Datum **elemsp, bool **nullsp, int *nelemsp);
extern PGDLLIMPORT bool array_contains_nulls(ArrayType *array);

extern PGDLLIMPORT ArrayBuildState *initArrayResult(Oid element_type,
										MemoryContext rcontext, bool subcontext);
extern PGDLLIMPORT ArrayBuildState *accumArrayResult(ArrayBuildState *astate,
										 Datum dvalue, bool disnull,
										 Oid element_type,
										 MemoryContext rcontext);
extern PGDLLIMPORT Datum makeArrayResult(ArrayBuildState *astate,
							 MemoryContext rcontext);
extern PGDLLIMPORT Datum makeMdArrayResult(ArrayBuildState *astate, int ndims,
							   int *dims, int *lbs, MemoryContext rcontext, bool release);

extern PGDLLIMPORT ArrayBuildStateArr *initArrayResultArr(Oid array_type, Oid element_type,
											  MemoryContext rcontext, bool subcontext);
extern PGDLLIMPORT ArrayBuildStateArr *accumArrayResultArr(ArrayBuildStateArr *astate,
											   Datum dvalue, bool disnull,
											   Oid array_type,
											   MemoryContext rcontext);
extern PGDLLIMPORT Datum makeArrayResultArr(ArrayBuildStateArr *astate,
								MemoryContext rcontext, bool release);

extern PGDLLIMPORT ArrayBuildStateAny *initArrayResultAny(Oid input_type,
											  MemoryContext rcontext, bool subcontext);
extern PGDLLIMPORT ArrayBuildStateAny *accumArrayResultAny(ArrayBuildStateAny *astate,
											   Datum dvalue, bool disnull,
											   Oid input_type,
											   MemoryContext rcontext);
extern PGDLLIMPORT Datum makeArrayResultAny(ArrayBuildStateAny *astate,
								MemoryContext rcontext, bool release);

extern PGDLLIMPORT ArrayIterator array_create_iterator(ArrayType *arr, int slice_ndim, ArrayMetaState *mstate);
extern PGDLLIMPORT bool array_iterate(ArrayIterator iterator, Datum *value, bool *isnull);
extern PGDLLIMPORT void array_free_iterator(ArrayIterator iterator);

/*
 * prototypes for functions defined in arrayutils.c
 */

extern PGDLLIMPORT int	ArrayGetOffset(int n, const int *dim, const int *lb, const int *indx);
extern PGDLLIMPORT int	ArrayGetOffset0(int n, const int *tup, const int *scale);
extern PGDLLIMPORT int	ArrayGetNItems(int ndim, const int *dims);
extern PGDLLIMPORT void ArrayCheckBounds(int ndim, const int *dims, const int *lb);
extern PGDLLIMPORT void mda_get_range(int n, int *span, const int *st, const int *endp);
extern PGDLLIMPORT void mda_get_prod(int n, const int *range, int *prod);
extern PGDLLIMPORT void mda_get_offset_values(int n, int *dist, const int *prod, const int *span);
extern PGDLLIMPORT int	mda_next_tuple(int n, int *curr, const int *span);
extern PGDLLIMPORT int32 *ArrayGetIntegerTypmods(ArrayType *arr, int *n);

/*
 * prototypes for functions defined in array_expanded.c
 */
extern PGDLLIMPORT Datum expand_array(Datum arraydatum, MemoryContext parentcontext,
						  ArrayMetaState *metacache);
extern PGDLLIMPORT ExpandedArrayHeader *DatumGetExpandedArray(Datum d);
extern PGDLLIMPORT ExpandedArrayHeader *DatumGetExpandedArrayX(Datum d,
												   ArrayMetaState *metacache);
extern PGDLLIMPORT AnyArrayType *DatumGetAnyArrayP(Datum d);
extern PGDLLIMPORT void deconstruct_expanded_array(ExpandedArrayHeader *eah);
