...
extern PGDLLIMPORT int	pg_reg_getnumstates(const regex_t *regex);
extern PGDLLIMPORT int	pg_reg_getinitialstate(const regex_t *regex);
extern PGDLLIMPORT int	pg_reg_getfinalstate(const regex_t *regex);
extern PGDLLIMPORT int	pg_reg_getnumoutarcs(const regex_t *regex, int st);
extern PGDLLIMPORT void pg_reg_getoutarcs(const regex_t *regex, int st,
							  regex_arc_t *arcs, int arcs_len);

/* Functions for gathering information about colors */
extern PGDLLIMPORT int	pg_reg_getnumcolors(const regex_t *regex);
extern PGDLLIMPORT int	pg_reg_colorisbegin(const regex_t *regex, int co);
extern PGDLLIMPORT int	pg_reg_colorisend(const regex_t *regex, int co);
extern PGDLLIMPORT int	pg_reg_getnumcharacters(const regex_t *regex, int co);
extern PGDLLIMPORT void pg_reg_getcharacters(const regex_t *regex, int co,
